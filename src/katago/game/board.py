...
class Board:
    ...
    def to_string(self):
        def get_piece(x, y):
            ...
            if self.board[loc] == Board.BLACK:
                ...
                return "O "
            elif (x == 3 or x == self.x_size / 2 or x == self.x_size - 1 - 3) and (
                y == 3 or y == self.y_size / 2 or y == self.y_size - 1 - 3
            ):
                return "* "
            else:
                return ". "
    ...
    def add_unsafe(self, pla, loc):
        ...
        if self.board[adj2] == Board.BLACK or self.board[adj2] == Board.WHITE:
            if self.group_head[adj2] != self.group_head[adj0] and self.group_head[adj2] != self.group_head[adj1]:
